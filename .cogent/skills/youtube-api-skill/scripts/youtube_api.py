...
# API Configuration
TEMPLATE_ID = "82305188582464621"
API_BASE_URL = "https://api.browseract.com/v2/workflow"

def run_youtube_task(api_key, keywords, upload_date="This week"):
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        print("Usage: python youtube_api.py <keywords> [upload_date]", flush=True)
        sys.exit(1)
    ...
    result = run_youtube_task(api_key, keywords, upload_date)
    if result:
